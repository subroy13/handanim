...
scene.add(
    CompositeAnimationEvent(
        events=[
            ...
            TranslateToAnimation(
                start_time=13.5, duration=2, data={"point": a_sq_label.position}
            ),
        ]
    ),
...
scene.add(
    CompositeAnimationEvent(
        events=[
            ...
            TranslateToAnimation(
                start_time=18.5, duration=2, data={"point": b_sq_label.position}
            ),
        ]
    ),
...
scene.add(
    event=FadeInAnimation(start_time=20.5, duration=1),
    drawable=b_sq_label,
)
...
scene.render(output_path, max_length=21)
