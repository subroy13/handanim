...
def hachure_lines(
    ...
    if angle != 0:
        rotated_polygons = [rotate_points(polygon, rotation_center, angle) for polygon in polygon_list] # do initial rotation of the polygon
    else:
